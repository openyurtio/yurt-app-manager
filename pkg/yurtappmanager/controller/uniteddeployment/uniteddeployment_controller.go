...
func (r *ReconcileUnitedDeployment) calculateStatus(instance *unitv1alpha1.UnitedDeployment, newStatus *unitv1alpha1.UnitedDeploymentStatus,
	...
	if poolFailure == nil {
		RemoveUnitedDeploymentCondition(newStatus, unitv1alpha1.UnitedPoolFailure)
	} else {
		SetUnitedDeploymentCondition(newStatus, NewUnitedDeploymentCondition(unitv1alpha1.UnitedPoolFailure, corev1.ConditionTrue, "Error", *poolFailure))
	}
