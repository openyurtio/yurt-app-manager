...
type Adapter interface {
	...
	ApplyPoolTemplate(ud *alpha1.YurtAppSet, poolName, revision string, replicas int32, pool runtime.Object) error
	...
	PostUpdate(ud *alpha1.YurtAppSet, pool runtime.Object, revision string) error
}
