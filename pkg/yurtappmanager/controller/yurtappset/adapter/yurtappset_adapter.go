...
func (a *DeploymentAdapter) ApplyPoolTemplate(ud *alpha1.YurtAppSet, poolName, revision string,
...
func (a *DeploymentAdapter) PostUpdate(ud *alpha1.YurtAppSet, obj runtime.Object, revision string) error {
	// Do nothing,
	return nil
}
