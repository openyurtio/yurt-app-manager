...
func (r *ReconcileYurtAppSet) controlledHistories(ud *appsalphav1.YurtAppSet) ([]*apps.ControllerRevision, error) {
...
func (r *ReconcileYurtAppSet) constructYurtAppSetRevisions(ud *appsalphav1.YurtAppSet) (*apps.ControllerRevision, *apps.ControllerRevision, int32, error) {
...
func (r *ReconcileYurtAppSet) cleanExpiredRevision(ud *appsalphav1.YurtAppSet,
...
func (r *ReconcileYurtAppSet) newRevision(ud *appsalphav1.YurtAppSet, revision int64, collisionCount *int32) (*apps.ControllerRevision, error) {
	patch, err := getYurtAppSetPatch(ud)
	if err != nil {
		return nil, err
	}
	...
	default:
		klog.Errorf("YurtAppSet(%s/%s) need specific WorkloadTemplate", ud.GetNamespace(), ud.GetName())
		return nil, fmt.Errorf("YurtAppSet(%s/%s) need specific WorkloadTemplate", ud.GetNamespace(), ud.GetName())
	}
...
func getYurtAppSetPatch(ud *appsalphav1.YurtAppSet) ([]byte, error) {
