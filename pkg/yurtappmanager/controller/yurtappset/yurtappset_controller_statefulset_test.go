...
func expectedStsCount(g *gomega.GomegaWithT, ud *appsv1alpha1.YurtAppSet, count int) *appsv1.StatefulSetList {
...
func clean(g *gomega.GomegaWithT, c client.Client) {
	udList := &appsv1alpha1.YurtAppSetList{}
